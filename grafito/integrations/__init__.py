...
def __getattr__(name: str):
    ...
    if name in ("to_pyvis", "save_pyvis_html", "plot_matplotlib", "save_matplotlib", "render_graph", "export_graph", "available_viz_backends", "register_viz_backend"):
        from .viz import (
            to_pyvis,
            save_pyvis_html,
            plot_matplotlib,
        ...
        return {
            ...
            "save_matplotlib": save_matplotlib,
